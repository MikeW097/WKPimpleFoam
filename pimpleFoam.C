...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        if (mesh.steady())
            Info << "Steady WK Model Chosen." << nl << endl;
        else
            Info << "Unsteady WK Model Chosen." << nl << endl;
        ...
        if (mesh.steady())
            execute_at_end(mesh, phi, store, "steady");
        else
            execute_at_end(mesh, phi, store, "unsteady");
